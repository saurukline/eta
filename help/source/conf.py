...
project = u'eta'
copyright = u'2013, Iuri Carvalho / VIX'
...
latex_documents = [
  ('index', 'eta.tex', u'eta Documentation',
   u'Iuri Carvalho / VIX', 'manual'),
]
...
man_pages = [
    ('index', 'TemplateClass', u'eta Documentation',
     [u'Iuri Carvalho / VIX'], 1)
]
